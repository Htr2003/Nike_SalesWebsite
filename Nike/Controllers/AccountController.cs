...
namespace Nike.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(KhachHang khachhang)
        {
            ...
            {
                var check = _db.KhachHang.FirstOrDefault(s => s.Email == khachhang.Email);
                if (check == null)
                {
                    String anh = "user.jpg";
        ...
        public ActionResult Login(string email, string password)
        {
            if (ModelState.IsValid)
            {
                KhachHang kh = _db.KhachHang.FirstOrDefault(s => s.Email.Equals(email) && s.Password.Equals(password));
                if (kh != null)
                {
                    Session["Taikhoan"] = kh;
                    Session["NV"] = null;
        ...
        public ActionResult ProFile()
        {
            ...
            KhachHang khachHang = _db.KhachHang.Find(kh.idUser);
        ...
        public ActionResult EditProFile(int idUser)
        {
            ...
            KhachHang kh = _db.KhachHang.Find(idUser);
        ...
        public ActionResult OrderList(string sr)
        {
            ...
            var orderList = (from s in _db.Order select s).ToList();
